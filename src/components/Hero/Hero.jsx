  ...
  return (
    <div className="h-hero h-screen overflow-hidden relative z-0  flexColumn w-full ">
      ...
      <div className="h-left h-full  flex flex-col justify-center items-center  text-white p-10 gap-5 bg-black/50">
        <h1 className="font-extrabold rounded-[10px] transform text-center text-6xl/17 p-4 ">
        ...
        <div className="flex gap-6 mt-5">
          ...
          <button className="btn inactive">Learn More</button>
        </div>
      </div>
      <div className="w-[410px] flex p-3 h-[130px] backdrop-blur-sm bg-gradient-to-br from-gray-700/30 to-green-800/10 border border-gray-400  absolute bottom-8 left-8 rounded-lg">
