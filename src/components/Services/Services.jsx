...
function Services() {
  return (
    <div className="px-32 pt-40 flex flex-col justify-start items-center w-full h-[80vh]">
      ...
      <div className="w-full h-full flex flex-row ">
        <div className="serv-left relative h-full flex justify-center items-center w-1/2 ">
          <span className="absolute bulb1 w-[32rem] h-[32rem] bg-green-300/20 "></span>
          <div className="mockup-phone border-none scale-50 h-[54rem] overflow-hidden ">
            <div className="mockup-phone-camera"></div>
            <div className="mockup-phone-display">
              <img
                alt="wallpaper"
                className="h-full object-cover shadow drop-shadow-2xl"
                src={home}
              />
            </div>
          </div>{" "}
