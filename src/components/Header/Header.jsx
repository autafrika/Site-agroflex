...
function Header() {
  return (
    <>
      ...
      <div className="fixed z-10 top-0 left-0 w-screen flex lg:hidden justify-between items-center  px-4  backdrop-blur-3xl">
        <div className="flex items-center rounded-s-md w-full lg:hidden text-white ">
          ...
          >
            <img
              src={agroflex}
              className="h-10 px-5 py-1 bg-white  border rounded-full w-auto lg:h-[4.5rem] drop-shadow-xl lg:w-auto "
              alt="logo autafrika"
            />
          </a>
        </div>

        <button className="navbar-burger flex items-center p-1 font-bold  rounded-md text-white ">
          <svg
            className="h-10 w-10 p-2  border border-white/70 bg-green-950/50 fill-white rounded-lg  text-gray-100 cursor-pointer hover:text-gray-100  hover:bg-green-950 hover:transition-colors duration-100"
            viewBox="0 0 20 20"
      ...
      <nav className=" fixed lg:hidden z-[999]  left-0 w-screen max-w-md h-fit py-6 px-6 pt-3 pl-4 gap-4 flex flex-col m-auto  bg-slate-100/70 shadow-xl backdrop-blur-md overflow-y-auto rounded-br-sm ">
        <div className="flex justify-between items-center rounded-md shadow-2xl bg-green-600/10">
          <div className="flex items-center rounded-s-md w-full lg:hidden text-white ">
            <a
            ...
            >
              <img
                src={agroflex}
                className="h-10  w-auto lg:h-[4.5rem] drop-shadow-xl lg:w-auto "
                alt="logo autafrika"
              />
            </a>
          </div>

          <button className="navbar-close p-3">
            <svg
              className="h-8 w-8 p-1 text-gray-600 cursor-pointer hover:text-gray-900 hover:rounded-full hover:bg-gray-400/30 hover:transition-colors duration-100"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
